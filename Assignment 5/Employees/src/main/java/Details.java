...
public class Details extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{  
			...
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/assignment5","root","root");   
			Statement stmt=con.createStatement();  
			ResultSet rs=stmt.executeQuery("select * from ebookshop");  
			out.println("<body style=\"background-image:linear-gradient(rgba(0,0,0,0.8),rgba(0,0,0,0.8)), url(back.jfif);\"><h1 style=\"text-align:center; color:#FFFFFF;\">Book Details</h1>");
